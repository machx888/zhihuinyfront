...
const res = await jidi.getMassifApi()
export const filterList = res.data.list
// 列表数据
// export const list = [
// 	{
// 		img: 'https://news.sznews.com/pic/2021-03/09/e37326cc-4583-48f3-aa00-ecc2392d319d.jpg',
// 		number:res.data.list.number,
// 		name: res.data.list.name,
// 		state: res.data.list.state,
// 		type: res.data.list.type,
// 		area: res.data.list.area,
// 		crop: res.data.list.crop,
// 		id:res.data.list.id,
// 		createTime:res.data.list.name,
// 	},
// 	{
