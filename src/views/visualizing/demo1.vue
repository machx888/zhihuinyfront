			...
			<div class="visualizing-container-head">
				...
				<div class="visualizing-container-head-center">
					<div class="visualizing-container-head-center-box">
						<div class="visualizing-container-head-center-maintitle">宁夏莱芝科技智慧生态有限公司</div>
...
const initEchartsMap = () => {
	...
	// 获取行政区域
	bdary.get('青铜峡鸟岛', function (rs: any) {
		// 行政区域的点有多少个
		...
		// eslint-disable-next-line no-undef
		map.centerAndZoom(new BMap.Point(105.925, 37.730), 12);
	});
};
// 产业概况
