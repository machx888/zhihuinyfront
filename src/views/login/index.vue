		...
		<div class="login-right flex">
			<div class="login-right-warp flex-margin">
				...
				<div class="login-right-warp-mian">
					...
					<div class="login-right-warp-main-title">莱芝智慧农业系统登录</div>
...
import logoMini from '/@/assets/LzkjLogin.png';
import loginMainimg from '/@/assets/loginbg3.png';
